...
namespace WorkFlowEngine.Api.Controllers
{
    ...
    public class ProcessManagerController : BaseApiController
    {
        ...
        public async Task<IActionResult> StartProcessInstance(StartProcessInstanceRequest request)
        {
            ...
            return ResturnResult<StartProcessInstanceResponse>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<ExecuteActivityActionResponse>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<List<string>>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<GetCurrentActivityResponse>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<List<Worklist>>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<bool>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<int>(result);
        }
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<List<GetUserWorklistResponse>>(result);
        ...
        {
            var result = await _mediator.Send(request);
            return ResturnResult<GetUserTaskInfoResponse>(result);
        }
